"""
Django settings for solr_pub_project.
...
ADMINS = json.loads( os.environ['SOLR_PUB__ADMINS_JSON'] )
...
# Email
SERVER_EMAIL = os.environ['SOLR_PUB__SERVER_EMAIL']
EMAIL_HOST = os.environ['SOLR_PUB__EMAIL_HOST']
EMAIL_PORT = int( os.environ['SOLR_PUB__EMAIL_PORT'] )
